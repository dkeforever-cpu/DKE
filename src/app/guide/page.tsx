      ...
      <div className="flex flex-1 flex-col gap-2.5 overflow-y-auto p-3">
        ...
        <Section title="업무 목록·등록">
          ...
          <Item title="새 업무 등록">
            ...
            함께, 캘린더에 표시될 색상을 직접 고르거나 자동 배정에 맡길 수 있습니다. &lsquo;협업자&rsquo;는
            여러 명을 함께 지정할 수 있고, 지정된 사람은 담당자와 마찬가지로 업무를 수정·관리할 수
            있습니다.
          </Item>
          <Item title="보고">
            목록에 &lsquo;보고&rsquo; 열을 노출하면(게시판/열 관리에서 설정) 행마다 &lsquo;완료/미보고&rsquo;
            버튼이 표시됩니다. 업무 진행 상태(진행중/완료 등)와는 별개로, 담당자가 실제로 상부나
            관계자에게 보고했는지 여부만 따로 체크해두는 용도입니다.
          </Item>
        ...
        <Section title="업무 상세">
          <Item title="필요 업무(체크리스트)">
            ...
            기한을 따로 지정하고 댓글도 달 수 있습니다. 전체 진행률은 하위 항목들의 평균으로 자동
            계산되며, 진행률이 100%가 되면 업무 상태도 자동으로 &lsquo;완료&rsquo;로 바뀝니다. 반대로
            완료된 업무의 체크리스트 항목을 다시 열어 진행률이 100% 밑으로 떨어지면 상태는 자동으로
            &lsquo;진행중&rsquo;으로 되돌아갑니다.
          </Item>
          <Item title="업무 메모">
        ...
        <Section title="캘린더">
          ...
          <Item title="일정 등록">
            ...
            본인 또는 관리자만 수정·삭제할 수 있습니다. 별도의 담당자 지정 항목은 없고,
            상단의 &lsquo;담당자&rsquo; 필터를 걸면 등록한 사람을 담당자로 보고 걸러줍니다.
          </Item>
        ...
        {currentUser.isAdmin && (
          <Section title="관리자 기능 (관리자 계정 전용)">
            ...
            <Item title="Excel">
              현재 데이터를 엑셀(.xlsx) 파일로 내려받습니다. &lsquo;캘린더&rsquo;(달력 형태로
              일정 표시) · &lsquo;전체업무&rsquo;(업무 목록, 업무명을 누르면 세부내용으로 이동) ·
              &lsquo;업무 세부내용&rsquo;(업무별 필요 업무·업무 메모·댓글) 3개 시트로 구성됩니다.
