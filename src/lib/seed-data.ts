...
export const USERS: User[] = [
  { id: "u1", name: "박관리", teamId: "관리팀", viewTeamIds: ["관리팀", "재경팀"], level: 1, isAdmin: true },
  { id: "u2", name: "이지원", teamId: "관리팀", viewTeamIds: ["관리팀"], level: 1, isAdmin: false },
  { id: "u3", name: "한서준", teamId: "관리팀", viewTeamIds: ["관리팀"], level: 1, isAdmin: false },
  { id: "u4", name: "오지훈", teamId: "관리팀", viewTeamIds: ["관리팀"], level: 1, isAdmin: false },
  { id: "u5", name: "서은채", teamId: "관리팀", viewTeamIds: ["관리팀"], level: 1, isAdmin: false },
  { id: "u6", name: "김재경", teamId: "재경팀", viewTeamIds: ["관리팀", "재경팀"], level: 1, isAdmin: true },
  { id: "u7", name: "정다은", teamId: "재경팀", viewTeamIds: ["재경팀"], level: 1, isAdmin: false },
